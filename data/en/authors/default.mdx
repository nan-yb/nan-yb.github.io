...
## Hi <Twemoji emoji="waving hand" /> I'm Yongbin (aka YB)
...
- Built [Room Finder](https://.github.io/get-a-room-api-docs/) (Back-end Developer)
- Built [Travel Egypt](https://github.com/yongbin-dev/Travel_Egypt) - a picture puzzle game made by pygame (Python)
...
- <Twemoji emoji="inbox-tray" /> Bumping up `mdx-bundler`, `rehype`/`remark` plugins and dependencies
  to the latest version기
See my [repository](https://github.com/yongbin-dev/yblog.dev) for this blog.

The legacy version built with **Gatsby** can be found [here](https://YB-blog-legacy.vercel.app/).
