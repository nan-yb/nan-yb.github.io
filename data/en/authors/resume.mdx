...
- [Shopify Theme Starter](https://github.com/nan-yb/shopify-theme-starter): Starter kit to build a Shopify Theme from scratch includes Webpack 5 and Tailwind CSS
- [Tiny retry](https://github.com/nan-yb/tiny-retry): A lightweight module (~0.5kb) to retry an async job until the job success or stop after a maximum number of tries
- [Slider-x](https://www.npmjs.com/package/slider-x): Vanilla JS library for PageFly premium element - SlideShow
- [Nodejs Google APIs Starter](https://github.com/nan-yb/nodejs-google-api-starter): NodeJS starter code for PageFly Analytics feature
- [Travel Egypt](https://github.com/nan-yb/Travel_Egypt): Picture puzzle game built with pygame (Python)
- [Infinite Gallery](https://github.com/nan-yb/infinite-gallery): Infinite loading modal gallery
- [Store Manager](https://github.com/nan-yb/StoreManager) Desktop store management app using Java Swing, JDBC, SQL Server
