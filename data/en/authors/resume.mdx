...
_Seoul, May 2021 - Apr 2022 (11 Months)_
...
_Seoul, May 2020 - Apr 2021 (11 Months)_
...
_Seoul, Aug 2018 - Apr 2020 (21 months)_
...
_Seoul, May 2017 - Jul 2018 (14 months)_
...
- **Description**: A mobile app for finding hotel or guesthouse in Seoul based on position, distance, price or hotel’s comforts
- **Team size**: 4
- **Position**: Back-end Developer
- **Responsibilities**:
  - Design database schema, implement all back-end services
  - Document APIs in detail at [https://.github.io/get-a-room-api-docs/](https://.github.io/get-a-room-api-docs/)
...
- [Shopify Theme Starter](https://github.com/yongbin-dev/shopify-theme-starter): Starter kit to build a Shopify Theme from scratch includes Webpack 5 and Tailwind CSS
- [Tiny retry](https://github.com/yongbin-dev/tiny-retry): A lightweight module (~0.5kb) to retry an async job until the job success or stop after a maximum number of tries
- [Slider-x](https://www.npmjs.com/package/slider-x): Vanilla JS library for PageFly premium element - SlideShow
- [Nodejs Google APIs Starter](https://github.com/yongbin-dev/nodejs-google-api-starter): NodeJS starter code for PageFly Analytics feature
- [Travel Egypt](https://github.com/yongbin-dev/Travel_Egypt): Picture puzzle game built with pygame (Python)
- [Infinite Gallery](https://github.com/yongbin-dev/infinite-gallery): Infinite loading modal gallery
- [Store Manager](https://github.com/yongbin-dev/StoreManager) Desktop store management app using Java Swing, JDBC, SQL Server
